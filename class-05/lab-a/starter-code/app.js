...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let prod=multiply(prod1,c)[0];
  return[sum2,prod,`${a} and ${b} and ${c} sum to ${sum2}.`,`The product of ${a} and ${b} and ${c} is ${prod}.`]
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  return [prod2, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${prod2}.`];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  return [total,`The numbers ${dynamicArray.join(',')} have a product of ${total}.`]
}
// Here is the test for multiplyArray(); uncomment it to run it
